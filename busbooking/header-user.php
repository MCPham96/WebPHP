...
<head>
    ...
    <title>Hệ Thống Đặt Vé Xe Buýt Online</title>
	<!-- Bootstrap Styles-->
        ...
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".sidebar-collapse">
                    <span class="sr-only">Hướng Chuyển Đổi</span>
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                    <span class="icon-bar"></span>
                </button>
                <a class="navbar-brand" href="index.html">Đặt vé xe Online</a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="customers_view.php"><i class="fa fa-users"></i> Khách Hàng</a>
                    </li>
					<li>
                        <a href="bookings_view.php"><i class="fa fa-money"></i> Đặt Vé</a>
                    </li>
                    <li>
                        <a href="buses_view.php"><i class="fa fa-truck"></i> Xe Buýt</a>
                    </li>
                    
                    <li>
                        <a href="seats_view.php"><i class="fa fa-sitemap"></i> Ghế</a>
                    </li>
                    <li>
                        <a href="availability_view.php"><i class="fa fa-check-circle"></i> Khả Dụng</a>
                    </li>
                    <li>
                        <a href="routes_view.php"><i class="fa fa-road"></i> Tuyến Đường</a>
                    </li>
			 ...
			 <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header">
                            Xin Chào  <small> <?php echo getLoggedMemberID();?></small>
                        </h1>
                        <?php alertcheck(); ?>
                    </div>
                  </div> 
                 ...
                 <!-- /. ROW  -->
				 <footer><strong><p> Đặt Vé Xe Online</p></strong></footer>
				</div>
             <!-- /. PAGE INNER  -->
            </div>
         <!-- /. PAGE WRAPPER  -->
